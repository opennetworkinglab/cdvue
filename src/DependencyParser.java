...
public class DependencyParser {
    ...
    private void processClass(JavaClass javaClass) {
        ...
        jsonObject.put("class name", fullyClassifiedName); //ease of access to get class's fully classified name
        jsonObject.put(fullyClassifiedName, javaClass); //mapping the fully classified name of the class to the actual JavaClass
        jsonObject.put(fullyClassifiedName + ":hc", isComponent); //whether the class has an @Component annotation
        jsonObject.put(fullyClassifiedName + ":hs", isService); //whether the class has an @Service annotation
        jsonObject.put(fullyClassifiedName + ":ca", classAnnotations); //all JavaAnnotations for the class
        jsonObject.put(fullyClassifiedName + ":ic", implementedClasses); //all JavaClass's that the class implements
        jsonObject.put(fullyClassifiedName + ":f", referenceFields); //all JavaField's from this class that contain an @Reference annotation
        jsonObject.put(fullyClassifiedName + ":ii", isInterface); //whether or not the JavaClass is an interface or not
